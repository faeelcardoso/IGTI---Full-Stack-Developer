var globalNames = ['Teste']; // aqui vai os nomes
var inputName = null; // input vazião
var isEditing = false;
var currentIndex = null;
 
window.addEventListener('load', start); // boas práticas de sempre
...
function activateInput() { 
  function insertName(newName) { // esse newName é o event.target.value ali de cima que está sendo passado
    ...
    globalNames.push(newName); // push adiciona no array, ou seja irá inserir o que foi digitado no array
    }
  }
...
function render(){ // vai preencher a div com os nomes digitados no input
  function createDeleteButton(index) { 
    ...
    function deleteName(){
      globalNames.splice(index, 1); // pego o index e excluo 1
